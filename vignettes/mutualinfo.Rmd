...
<div class="figure">
<img src="figure/histislandspecies-1.jpeg" alt="**Revisability of mutual information with a much larger data sample**" width="100%" />
<p class="caption">**Revisability of mutual information with a much larger data sample**</p>
</div>

```
# Error in `plotquantiles()`:
# ! object 'xaxp' not found
```
