...
[^1]: - [*variate*](https://dictionary.cambridge.org/dictionary/english/variate): a quantity that can take the value of any member of a particular set (= group).
- [*variable*](https://dictionary.cambridge.org/dictionary/english/variable) a number, amount, or situation that can change.
